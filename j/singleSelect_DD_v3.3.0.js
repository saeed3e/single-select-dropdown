/*global ieObj*/
/*jslint eqeq:true*/
/*******Start of singleDD (version : v.3.3.0)*/
...
(function($) {
    ...
    $.fn.singleDD = function(opt) {
        ...
        function init(node) {
            ...
            _t.dropCont = $('<div class="sDrop ' + scrollClass + '"></div>').css({
            ...
            _t.select = function(key) {
                _t.setVal_inHiddenField.call(_t, opts.data[key], this.remDelimiter(key));
            };
...
// select function for single DD case
